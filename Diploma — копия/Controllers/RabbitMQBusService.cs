    ...
    public class RabbitMQBusService: BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (ch, ea) =>
            {
                ...
                YamlConfiguration yamlConfiguration = _messageHandler.ParseYamlString(content);
                //Debug.WriteLine($"Получено сообщение: {content}");
                Tuple<string, Message> message = _messageHandler.CreateMessage(yamlConfiguration);
